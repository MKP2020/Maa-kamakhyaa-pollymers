...
import { TLoomFull } from "@/lib/schemas";
import { generatePdf } from "@/lib/generate-pdf/lamination";
import { getLamList } from "@/actions/lam";

interface DataTableProps {
  columns: ColumnDef<TLoomFull, any>[];
  data: TLoomFull[];
  searchKey: string;
  pageNo: number;
  total: number;
    ...
    <>
      <div id="table-indent" className="flex items-start justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button
            className="text-xs md:text-sm"
            onClick={() => router.push(`/dashboard/lamination/new`)}
          >
